...
const navigation = [
  ...
  { name: 'Semua model', href: 'Produk', current: false },
  { name: 'T Seri', href: 'Tseri', current: false },
  { name: 'X Seri', href: 'Xseri', current: false },
...
export default function Example() {
  return (
    <Disclosure as="nav" className="bg-white fixed-top shadow-2xl">
      {({ open }) => (
        <>
          <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 ">
            <div className="relative flex items-center justify-between h-16">
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'bg-gray-900 text-white' : 'text-black-300 hover:bg-indigo-600 hover:text-white',
              ...
              <div className="flex-shrink-0 flex items-center ">
                  ...
                  <img
                    className="block sm:hidden h-6 w-auto mx-auto"
                    src="pipo (2).png"
                    alt="Workflow"
                  />
                </div>
