            ...
            <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
              <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
                <div className="md:max-w-md lg:col-span-2">
                  ...
                  <div className="mt-4 lg:max-w-sm">
                    ...
                    Vivo mengembangkan produk yang dinamis dan bergaya untuk kaum muda yang penuh semangat dan energik. Kami fokus untuk menciptakan smartphone yang memberikan pengalaman terbaik bagi konsumen di fotografi dan audio Hi-Fi.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex flex-col justify-between pt-5 pb-10 border-t border-deep-purple-accent-200 sm:flex-row">
                <p className="text-sm text-gray-100">
                  © Copyright 2022 vivo Mobile Communication Co., Ltd. Semua hak dilindungi undang-undang. | Kebijakan Privasi | Kebijakan Kuki | Dukungan Privasi
